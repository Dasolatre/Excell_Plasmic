...
import sty from "./PlasmicModal.module.css"; // plasmic-import: SxRk_LenlqCW/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_Ng38O99zMasO"]]: true })}
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__eOXo)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__ze7Vh)}>
                  <Button
                    color={"muted"}
                    label={
                      <div
